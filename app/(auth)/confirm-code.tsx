...
export default function ConfirmCodePage() {
    ...
    const { verifyCode, loading } = useForgetPassword();
    ...
    const handleContinue = () => {
        ...
        // Pass the array and email to the hook
                            ...
                            <View className="flex-row gap-2 mb-6">
                                {code.map((digit, index) => (
                                    <TextInput
                                        ...
                                        maxLength={1}
                                        className="flex-1 h-14 text-center text-[22px] font-bold border-[1.5px] border-gray-200 rounded-xl text-gray-800 bg-gray-50"
                                    />
                                ))}
                            </View>
